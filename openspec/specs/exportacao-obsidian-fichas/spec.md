# exportacao-obsidian-fichas Specification

## Purpose
Define os requisitos técnicos e de automação para a exportação de fichas de manutenção de vias de escalada em formato Markdown compatível com o Obsidian.
