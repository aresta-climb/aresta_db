...
## Purpose
Permite a visualização, navegação hierárquica e manipulação estrutural (adição, remoção, reordenação e migração) das mensagens e entidades do croqui na árvore de dados.
## Requirements
