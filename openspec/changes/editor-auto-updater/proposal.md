...
- **Auto-Instalação Canônica**: Se o usuário executar o aplicativo de pastas não-oficiais (como Downloads ou Desktop), a biblioteca criará a pasta base em `%LOCALAPPDATA%\ArestaEditor`, moverá a si mesma para lá e deixará um atalho (`.lnk`) na pasta de origem.
