...
- **THEN** ele MUST gerar uma string de justificativa (`llm_reasoning`).
- **THEN** ele MUST tentar extrair um sumário do movimento (ex: detalhamento de agarras e crux) para popular a estrutura semântica `MetaBeta`.
