...
- **mapas**:
  - **[0]**:
    ...
    - **altura_mapa**: 1489
  - **[1]**:
    - **caminho_imagem_mapa**: ![caminho_imagem_mapa](imagens/setor_vieiras_p1_i0.webp)
    - **largura_mapa**: 2048
    - **altura_mapa**: 1793
- **escaladas**:
  - **[0]**:
...
- **arquivos_externos**:
  ...
  - **[1]**:
    - **caminho**: ![caminho](imagens/setor_vieiras_p0_i0.webp)
    - **checksum_sha256**: fd306fc89c3568f4073f1a626ca74d296ec95eb431d085a43d9bbf1c4b85ed79
  - **[2]**:
    - **caminho**: ![caminho](imagens/setor_vieiras_p1_i0.webp)
