    ...
    - **destino**:
      - **secao_textual**:
        - **conteudo**:
            ...
            | ![Croqui Pilastras + Pedreira](imagens/capa_p0_i1.webp) |
            | :--: |
            | *Croqui Pilastras + Pedreira* |
    ...
    - **destino**:
      - **secao_textual**:
        - **conteudo**:
            ...
            | ![Mapa de acesso](imagens/como_chegar_p0_i1.webp) |
            | :--: |
            | *Mapa de acesso* |
            ...
            | ![Caixa d'água](imagens/como_chegar_p1_i1.webp) |
            | :--: |
            | *Caixa d'água* |
            ...
            | ![Estacionamento e início da trilha](imagens/como_chegar_p1_i2.webp) |
            | :--: |
...
- **mapas**:
  - **[0]**:
    ...
    - **altura_mapa**: 581
  - **[1]**:
    - **caminho_imagem_mapa**: ![caminho_imagem_mapa](imagens/setor_o_vale_p1_i1.webp)
    - **largura_mapa**: 478
    - **altura_mapa**: 886
  - **[2]**:
    - **caminho_imagem_mapa**: ![caminho_imagem_mapa](imagens/setor_o_vale_p2_i1.webp)
    - **largura_mapa**: 556
    - **altura_mapa**: 946
- **escaladas**:
  - **[0]**:
...
- **mapas**:
  - **[0]**:
    ...
    - **altura_mapa**: 388
  - **[1]**:
    - **caminho_imagem_mapa**: ![caminho_imagem_mapa](imagens/setor_a_pedreira_p2_i1.webp)
    - **largura_mapa**: 960
    - **altura_mapa**: 720
- **escaladas**:
  - **[0]**:
