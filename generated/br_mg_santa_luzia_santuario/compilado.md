    ...
    - **destino**:
      - **secao_textual**:
        - **conteudo**:
            ...
            | ![Capa do Guia de Escalada Santuário](imagens/capa_p0.webp) |
            | :--: |
    ...
    - **destino**:
      - **secao_textual**:
        - **conteudo**:
            ...
            | ![Trilha pela linha de trem](imagens/como_chegar_p0_i2.webp) |
            | :--: |
            | *Trilha pela linha de trem* |
            
            | ![Sinalização no cruzamento ferroviário](imagens/como_chegar_p0_i0.webp) |
            | :--: |
      ...
      - **secao_textual**:
        - **conteudo**:
            ...
            **Recomendações:**
            ...
            | ![Fachada do Bar do Sr. João](imagens/comercio_local_p0_i2.webp) |
            | :--: |
            | *Fachada do Bar do Sr. João* |
            
            | ![Pastel de feira](imagens/comercio_local_p0_i1.webp) |
            | :--: |
            | *Pastel de feira* |
            
            | ![Sr. João no balcão](imagens/comercio_local_p0_i0.webp) |
            | :--: |
            | *Sr. João no balcão* |
  - **[3]**:
    ...
    - **destino**:
      - **secao_textual**:
        - **conteudo**:
            ...
            | ![Vista do domo do Santuário](imagens/informacoes_p0_i0.webp) |
            | :--: |
            ...
            | ![Logos de apoiadores](imagens/informacoes_p0.webp) |
            | :--: |
            | *Logos de apoiadores* |
  - **[4]**:
...
- **arquivos_externos**:
  ...
  - **[15]**:
    - **caminho**: ![caminho](imagens/setor_santa_linea_p0_i0.webp)
    - **checksum_sha256**: 3e4a8ee1c0b1fa746294b2c6453bf5d9b3797c70541d4bfa81d566d363ac2e55
  - **[16]**:
    - **caminho**: ![caminho](imagens/setor_santa_linea_p1.webp)
