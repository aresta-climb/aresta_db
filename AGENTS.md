...
## III. 100% de unit test coverage
Qualquer commit submetido no Fixalog deve possuir 100% de unit test coverage. Isso é Inegociável.
...
## V. Testes de Integração em Primeiro Lugar
