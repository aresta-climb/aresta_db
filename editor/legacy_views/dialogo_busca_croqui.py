...
from PySide6.QtWidgets import QDialog, QVBoxLayout, QLineEdit, QListWidget, QPushButton, QHBoxLayout, QWidget
...
class DialogoBuscaCroqui(QDialog):
    ...
    def __init__(self, storage: Optional[Any] = None, parent: Optional[QWidget] = None) -> None:
        ...
        self.id_selecionado: Optional[str] = None
        ...
        self.layout_botoes: QHBoxLayout = QHBoxLayout()
        self.btn_cancelar: QPushButton = QPushButton("Cancelar")
        self.btn_confirmar: QPushButton = QPushButton("Confirmar")
    ...
    def filtrar_lista(self, texto: str) -> None:
        """
