...
def resolver_caminho_mensagem(root_msg, target_msg) -> str:
    """
...
def navegar_para_mensagem(root_msg, caminho: str):
    """
...
def _serializar_valor(valor, anonimizado: bool = False):
...
def _deserializar_valor(valor_serializado, model=None):
...
class CmdAlterarPrimitivo(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdAlterarPrimitivo":
...
class CmdAdicionarRepeated(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdAdicionarRepeated":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
...
class CmdRemoverRepeated(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdRemoverRepeated":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
...
class CmdAlterarOneof(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdAlterarOneof":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
...
class CmdAlterarRepeatedItem(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdAlterarRepeatedItem":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
        valor_antigo = _deserializar_valor(dados["valor_antigo"], model=model)
        valor_novo = _deserializar_valor(dados["valor_novo"], model=model)
...
class CmdAlterarMultiplosRepeatedItems(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdAlterarMultiplosRepeatedItems":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
        alt_deserializadas = [
...
class CmdMoverRepeated(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdMoverRepeated":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
...
class CmdAlterarMetadadosCaminhoNovo(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdAlterarMetadadosCaminhoNovo":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
        import aresta_api.proto.generated.croqui_pb2 as croqui_pb2
...
class CmdAlterarCampoImagem(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdAlterarCampoImagem":
        msg = navegar_para_mensagem(model.obter_croqui_readonly(), dados.get("caminho_msg", ""))
...
class CmdSubstituirImagemMemoria(ComandoEditor):
    ...
    @staticmethod
    def deserializar(dados: dict, model: CroquiModel) -> "CmdSubstituirImagemMemoria":
...
def deserializar_comando(dados: dict, model: CroquiModel) -> QUndoCommand:
    ...
    if classe_nome in mapa_classes:
        return mapa_classes[classe_nome].deserializar(dados, model)
